...
public class JsonParser {
    ...
    public static void main(String[] args) throws IOException {
        System.out.println("deserialization: converting json string to object");
        Company company = toObjectFromJson(companyStr, Company.class);
        System.out.println(company);
        System.out.println("serialization: converting object to json String");
        String jstring = toJson(company, true, true);
